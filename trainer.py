    ...
    def train(self):
        ...
        while True:
            for i, (real_image, label) in enumerate(self.train_data):
                real_image, label = real_image.to(self.device), label.to(self.device)
                ...
                if i % 10 == 0:
                    ...
                    save_image(real_image, "{}/{}-{}-real_img.jpg".format(self.save_img_path, epoch, i), 20,
                               normalize=True, scale_each=True)
                    save_image(g_fake_img, "{}/{}-{}-fake_img.jpg".format(self.save_img_path, epoch, i), 20,
                               normalize=True, scale_each=True)
...
if __name__ == '__main__':
    trainer = Trainer("models/", "images/", "datasets/")
    trainer.train()
